                ...
                <div class="card-body">
                    <form action="Controlador?menu=Cliente" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${cliente.getDir()}" name="txtDireccion" class="form-control" required> 
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
                        ...
                        <c:forEach var="c" items="${clientes}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" href="Controlador?menu=Cliente&accion=Eliminar&id=${c.getId()}">Eliminar</a>  
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
